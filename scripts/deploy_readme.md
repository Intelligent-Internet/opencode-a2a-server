...
For product/protocol behavior and runtime auth contract, see [`../docs/guide.md`](../docs/guide.md).
...
| `A2A_JWT_ALGORITHM` | `a2a_jwt_algorithm` | Optional | `RS256` | JWT verification algorithm for runtime. |
